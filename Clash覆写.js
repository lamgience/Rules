...
function main(config) {
  ...
  config["proxy-groups"] = [
    ...
    { name: "Perplexity", type: "select", proxies: aiProxies, icon: "https://api.iconify.design/simple-icons:perplexity.svg", ...commonFilter },
    ...
    { name: "DeepL", type: "select", proxies: aiProxies, icon: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/deepl.svg", ...commonFilter },
    { name: "Poe", type: "select", proxies: aiProxies, icon: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/poe.svg", ...commonFilter },
    { name: "Suno", type: "select", proxies: aiProxies, icon: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/suno.svg", ...commonFilter },
    { name: "Civitai", type: "select", proxies: aiProxies, icon: "https://api.iconify.design/ri:ai-generate.svg", ...commonFilter },
    ...
    { name: "Docker", type: "select", proxies: appProxies, icon: "https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/docker.svg", ...commonFilter },
    ...
    { name: "加密货币", type: "select", proxies: ["新加坡节点", "台湾节点", "日本节点", "手动切换", "DIRECT"], icon: "https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/bitcoin.svg" },
